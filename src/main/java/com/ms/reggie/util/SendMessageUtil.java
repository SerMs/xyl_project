...
public class SendMessageUtil {
    ...
    //SMS用户id
    private static String uid = "suiyige";

    //接口秘钥：SMS登录可查
    private static String key = "d41d8cd98f00b204e98a";

    //http://sms.webchinese.cn/web_api/
    private static String SMS_Url = "http://gbk.api.smschinese.cn/";
